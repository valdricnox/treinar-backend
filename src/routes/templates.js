...
const TEMPLATES = [
  { id:'nr18', norma:'NR-18', titulo:'Verificacao de EPI - Obra', itens:[
  ...
  { id:'nr35', norma:'NR-35', titulo:'Trabalho em Altura - Pre-Atividade', itens:[
  ...
  { id:'nr6', norma:'NR-6', titulo:'Inspecao Semanal de EPI', itens:[
  ...
  { id:'nr12', norma:'NR-12', titulo:'Inspecao de Maquinas e Equipamentos', itens:[
...
router.get('/', auth, (req, res) => {
  ...
  res.json(norma ? TEMPLATES.filter(t => t.norma === norma) : TEMPLATES);
});
